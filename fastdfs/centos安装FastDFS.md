...
- 配置
  ...
  ```shell
  sudo ./configure --prefix=/opt/nginx --sbin-path=/usr/bin/nginx --add-module=/home/leyou/fastdfs/fastdfs-nginx-module/src
  ```
...
![1568625379072](C:\Users\86151\AppData\Roaming\Typora\typora-user-images\1568625379072.png)
...
执行命令  /usr/bin/fdfs_upload_file client.conf /tmp/1524297355371.jpg 注意上传文件要在client.conf路径下

修改host的配置文件和nginx的要保持一致.
